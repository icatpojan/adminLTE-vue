    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-">Modal STATUS</h4>
                <button type="button" class="btn btn-sm" v-on:click="closeModal">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form @submit.prevent="StatusStore">
                    <div class="row mb-2">
                        <div class="col">
                            <input type="text" class="form-control" v-model="status.status_produk" placeholder="Masukkan nama kategori">
...
export default {
    ...
    methods: {
        ...
        StatusStore() {
            axios.post("http://localhost/status", this.status)
                .then(response => {
